...
<head>
	...
	<title>Login - Applied Mathematics Computing</title>
		...
		if (isset($_POST['login']))
			{
				...
				$query 		= mysqli_query($con, "SELECT * FROM st_applied_mathematics_and_computing WHERE  password='$password' and username='$username'");
				...
				if ($num_row > 0) 
					{			
						...
						header('location:InsertData\formfilling.php');
