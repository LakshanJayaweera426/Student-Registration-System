...
<head>
	...
	<title>Login - Information Communication Technology</title>
		...
		if (isset($_POST['login']))
			{
				...
				$query 		= mysqli_query($con, "SELECT * FROM st_information_communication_technology WHERE  password='$password' and username='$username'");
				...
				if ($num_row > 0) 
					{			
						...
						header('location:InsertData\ICTS-Technology.php');
