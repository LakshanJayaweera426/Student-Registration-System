...
<head>
	...
	<title>Admin - Information Communication Technology</title>
		...
		if (isset($_POST['login']))
			{
				...
				$query 		= mysqli_query($con, "SELECT * FROM admin_information_communication_technology WHERE  password='$password' and username='$username'");
